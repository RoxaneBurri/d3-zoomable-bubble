...
function* C(e) {
  ...
  for (const t in e)
    !n(t) && f(e, t) && (yield q(t, p(e, t), 'observablehq--key'));
...
function* I(e) {
  ...
  for (const r = e.size; n < r; ++n)
    n > t + 1 && (yield F(n - t - 1)), yield ie(e.get(n), !0), (t = n);
  n > t + 1 && (yield F(n - t - 1));
}
function* R(e) {
  let t = -1,
  ...
  for (const n = e.length; r < n; ++r)
    r in e &&
      (r > t + 1 && (yield F(r - t - 1)), yield ie(p(e, r), !0), (t = r));
  r > t + 1 && (yield F(r - t - 1));
  for (const t in e)
        ...
        if (!1 === t) {
          ...
          if (i.length > 20 && !n) {
            ...
            (a.className = 'observablehq--string'),
              (a.textContent = '`' + Y(i.slice(0, 20).join('\n')));
...
function Qe(
  ...
  return async function (r, o) {
    ...
    if (!i.version && null != o && o.startsWith(e)) {
      ...
      i.version =
        (t.dependencies && t.dependencies[i.name]) ||
        (t.peerDependencies && t.peerDependencies[i.name]);
    }
    if (
      (i.path && !Je.test(i.path) && (i.path += '.js'),
      i.path && i.version && Ke.test(i.version))
    )
      return `${e}${i.name}@${i.version}/${i.path}`;
    const a = await n(i);
    return `${e}${a.name}@${a.version}/${
      i.path ||
      (function (e) {
        for (const n of t) {
          let t = e[n];
          if ('string' == typeof t)
            return (
              t.startsWith('./') && (t = t.slice(2)), Je.test(t) ? t : `${t}.js`
            );
        }
      })(a) ||
      'index.js'
...
function tt(e) {
  ...
  function i(e) {
    return arguments.length > 1
      ? Promise.all(Ve.call(arguments, n)).then(nt)
      : n(e);
  }
  return (
    (i.alias = function (t) {
...
function nt(e) {
  ...
  for (const n of e)
    for (const e in n)
      Ye.call(n, e) &&
        (null == n[e]
          ? Object.defineProperty(t, e, { get: rt(n, e) })
          : (t[e] = n[e]));
  return t;
}
function rt(e, t) {
  ...
  r < 2
    ...
    We.push(
      Ge.call(t, ot)
        ...
        : (e) =>
            Promise.all(Ve.call(t, e)).then((e) =>
  ...
  sheet(e, t) {
    ...
    return (function (e, { range: t, headers: n } = {}) {
      let [[r, o], [i, a]] = (function (
        ...
        const [[r = 0, o = 0], [i = t - 1, a = n - 1]] = e.split(':').map(mt);
        return [
          [r, o],
          [i, a],
        ];
...
var xt = {
  ...
  element: function (e, t) {
    ...
    var i = _t.hasOwnProperty(r)
      ? document.createElementNS(_t[r], e)
...
const Zt = Object.assign(
  async (e, t, n) => {
    if (
      ((e = await Kt(await e, 'table')),
      (r = e) &&
        ('function' == typeof r.sql ||
          ('function' == typeof r.queryTag &&
            ('function' == typeof r.query ||
              'function' == typeof r.queryStream))) &&
        ('table' !== o || 'function' == typeof r.describeColumns) &&
        r !== Zt)
    )
      return Jt(
        e,
        (function (e, t) {
          const n = 'function' == typeof t.escape ? t.escape : (e) => e,
            { select: r, from: o, filter: i, sort: a, slice: s } = e;
          ...
          const c = [
            [
              `SELECT ${
                r.columns ? r.columns.map((e) => `t.${n(e)}`) : '*'
              } FROM ${Xt(o.table, n)} t`,
            ],
          ];
    ...
    if (Wt(e))
      return (function (e, t) {
        ...
        let { from: a, to: s } = t.slice;
        (a = null == a ? 0 : Math.max(0, a)),
          (s = null == s ? 1 / 0 : Math.max(0, s)),
          (a > 0 || s < 1 / 0) && (e = e.slice(Math.max(0, a), Math.max(0, s)));
        if (t.select.columns) {
          if (r) {
...
async function Kt(e, t) {
  if (e instanceof FileAttachment) {
    ...
    if (
      ('table' === t || 'sql' === t) &&
      'application/x-sqlite3' === e.mimeType
    )
      return e.sqlite();
      ...
      return (async function* (e) {
        ...
        try {
          ...
          do {
            ...
            if (t.done) n.done = !0;
            else for (const e of t.value) n.push(e);
            yield n;
          } while (!n.done);
        } catch (e) {
          (n.error = e), yield n;
...
function en({ column: e, direction: t }, n) {
  Qt(`t.${e} ${t.toUpperCase()}`, n);
}
function tn({ type: e, operands: t }, n) {
  ...
  if (2 !== t.length || ['in', 'nin'].includes(e)) {
    ...
    !(function (e, t) {
      let n = !0;
      for (const r of e)
        n ? (n = !1) : Qt(',', t), t.push(r.value), t[0].push('');
    })(t.slice(1), n),
      Qt(')', n);
  } else {
    if (['c', 'nc'].includes(e)) {
      ...
      return void nn(((r = t[1]), { ...r, value: `%${r.value}%` }), n);
    }
    switch ((nn(t[0], n), e)) {
      case 'eq':
        Qt(' = ', n);
...
var Library = Object.assign(
  Object.defineProperties(
        ...
        ((n = {
                        ...
                        e(Ae.resolve()).then(function (t) {
                          o.forEach(function (n) {
                            ...
                            t.getLanguage(n.className)
                              ? r()
                              : e(Ae.resolve('async-languages/index.js'))
                                  .then((r) => {
          ...
          tex: () =>
            (function (e) {
              return Promise.all([
                e(qe.resolve()),
                e.resolve(qe.resolve('dist/katex.min.css')).then(Ft),
              ]).then(function (e) {
                var t = e[0],
                  n = r();
                function r(e) {
          ...
          _: () => t($e.resolve()),
          aq: () => t.alias({ 'apache-arrow': Re.resolve() })(Ue.resolve()),
          Arrow: () => t(Re.resolve()),
          d3: () => t(xe.resolve()),
          Inputs: () =>
            t(Ne.resolve()).then((e) => ({ ...e, file: e.fileOf(wt) })),
          L: () =>
            (async function (e) {
              ...
              if (!t._style) {
                ...
                (n.rel = 'stylesheet'),
                  (n.href = await e.resolve(ze.resolve('dist/leaflet.css'))),
    ...
    {
      resolve: { get: () => at.resolve, enumerable: !0, configurable: !0 },
      require: {
        get: () => at,
        set: function (e) {
          at = e;
...
function Variable(e, t, n) {
  ...
  n || (n = ln),
    Object.defineProperties(this, {
      ...
      _definition: { value: dn, writable: !0 },
      ...
      _reachable: { value: n !== ln, writable: !0 },
      _rejector: {
        value:
          ((r = this),
          function (e) {
      ...
      ((a = r.get(e))
        ? 3 === a._type
          ...
          : ((a._duplicate = a._definition),
            (this._duplicate = n),
            ((i = new Variable(3, this._module))._name = e),
            (i._definition = this._definition = a._definition = hn(e)),
  ...
  define: {
    value: function (e, t, n) {
      ...
      return mn.call(
        this,
        null == e ? null : e + '',
        null == t ? [] : sn.call(t, this._module._resolve, this._module),
        'function' == typeof n ? n : on(n)
      );
    },
    writable: !0,
    configurable: !0,
      ...
      value: function (e) {
        ...
        if (!n)
          if (((n = new Variable(2, this)), this._builtins.has(e)))
            n.define(e, on(this._builtins.get(e)));
...
function An(e) {
  ...
  const o = (e._promise = (
    e._inputs.length
      ? Promise.all(e._inputs.map(Nn)).then(function (o) {
    ...
    value: function (e, t, n) {
      ...
      for (const e of r) {
        ...
        for (const o of e.variables)
          o.from
            ? t.import(o.remote, o.name, c(o.from))
            : t === s
      ...
      value: async function () {
        ...
        do {
          for (
            ...
            An(t), t._outputs.forEach(o), e.delete(t);
          e.forEach(function (t) {
            En(t) &&
              (qn(t, new RuntimeError('circular definition')),
              t._outputs.forEach(xn),
              e.delete(t));
          });
        } while (e.size);
        function o(e) {
